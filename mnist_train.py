...
class Draw():
    ...
    def train(self, args):
        ...
        for i in range(self.nb_steps):
            ...
            if i % 1000 == 0:
                saver.save(self.sess, os.getcwd()+"/logs/"+args.name+"/checkpoints/chkpt", global_step=i)
...
def get_arg_parser():
    ...
    parser.add_argument('-ns', '--nb_steps', default=15000, type=int, help="Number of steps to train the agent", dest="nb_steps")
